class PhoneDirectory {
    ...
    List<Integer> phone_avail;
    public PhoneDirectory(int maxNumbers) {
        this.phone_avail = new ArrayList<>();
    ...
    public int get() {
        ...
        int phone = this.phone_avail.getLast();
        this.phone_in_use.add(phone);
        this.phone_avail.removeLast();
        return phone;
    }
    
    public boolean check(int number) {
        return !this.phone_in_use.contains(number);
    }
